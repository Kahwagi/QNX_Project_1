...
# Binaries to build
BINS = sensor_server sensor_client 
#tcp_receiver
...
# Compile rules
sensor_server.o: sensor_server.c sensor_def.h tcp_conf.h aes_key.h
...
sensor_server: sensor_server.o
	$(LD) $(LDFLAGS) -lsocket -lssl -lcrypto -o sensor_server sensor_server.o
